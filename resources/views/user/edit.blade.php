                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('dateOfBirth') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="dateOfBirth" type="date" class="form-control" name="dateOfBirth" value="{{ Auth::user()->dateOfBirth }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('phoneNumber') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="phoneNumber" type="tel" class="form-control" name="phoneNumber" value="{{ Auth::user()->phoneNumber }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('country') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="country" type="text" class="form-control" name="country" value="{{ Auth::user()->country }}">
                            </div>
                        </div>
